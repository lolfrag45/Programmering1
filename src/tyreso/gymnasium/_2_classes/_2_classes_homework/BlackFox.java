...
public class BlackFox {

    //Variables, initializing directly after declaration ( BAD IDEA(tm) )
    String species = "BlackFox";

    //Constructor omitted, using default Java-constructor

    //Methods
    public String sound() {
        System.out.println("there are a higher procenteges of white people of welfare than there are black people of welfare");
        return "there are a higher procenteges of white people of welfare than there are black people of welfare";
    }
